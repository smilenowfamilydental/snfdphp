...
jQuery(document).ready(function(){
        ...
        $("#message").slideUp(500,function() {
            ...
            $.post(action, {
                ...
                function(data){
                    document.getElementById('message').innerHTML = data;
                    $('#message').slideDown('slow');
                    $("#ap-submit").html("Request to Schedule");
   ...
   jQuery(document).ready(function(){
       jQuery("#header-1").load("header.html");
   });
   ...
   jQuery(document).ready(function(){
       jQuery("#content-3-11").load("navigation.html");
   });
