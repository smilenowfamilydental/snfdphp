...
/* Admin Copy */
$e_body    = "You have a contact request by $fname $lname from your website, details are as follows." . PHP_EOL . PHP_EOL;
...
$f = smtpmailer($email, "smilenowfamilydental@gmail.com", "Smile Now Family Dental", "Contact Request", $f_msg);
$e = smtpmailer("smilenowfamilydental@gmail.com", "smilenowfamilydental@gmail.com", "Smile Now Family Dental", "Contact Request", $e_msg);
...
if ($e == 1 and $f == 1) {
    ...
    echo "<h2>Contact request has been created successfully.</h2>";
    echo "<p>Thank you <strong>$fname $lname</strong> for choosing Smile Now Family Dental for your dental needs. Our coordinator will contact you as soon as possible.</p>";
    echo "</div>";
    echo "</fieldset>";
